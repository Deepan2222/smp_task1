        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceStatusName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "StudentDocumentTypes",
                columns: table => new
                {
                    StudentDocumentTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentDocumentTypes", x => x.StudentDocumentTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: true),
                    RegisterNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DateOfBirth = table.Column<DateOnly>(type: "date", nullable: false),
                    Gender = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_EmployeeAttendance_Time", "[CheckOutTime] IS NULL OR [CheckInTime] IS NULL OR [CheckOutTime] >= [CheckInTime]");
                    table.ForeignKey(
                        name: "FK_EmployeeAttendances_AttendanceStatuses_AttendanceStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceDate = table.Column<DateOnly>(type: "date", nullable: false),
                    AttendanceStatusId = table.Column<int>(type: "int", nullable: true),
                    MarkedByEmployeeId = table.Column<int>(type: "int", nullable: true),
                    Remarks = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSUTCDATETIME()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentAttendances_AttendanceStatuses_AttendanceStatusId",
                        column: x => x.AttendanceStatusId,
                        principalTable: "AttendanceStatuses",
                        principalColumn: "AttendanceStatusId",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentDocumentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentId = table.Column<int>(type: "int", nullable: true),
                    StudentDocumentTypeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentDocuments_StudentDocumentTypes_StudentDocumentTypeId",
                        column: x => x.StudentDocumentTypeId,
                        principalTable: "StudentDocumentTypes",
                        principalColumn: "StudentDocumentTypeId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceStatuses_AttendanceStatusName",
                table: "AttendanceStatuses",
                column: "AttendanceStatusName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAttendances_AttendanceStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAttendances_AttendanceStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentDocuments_StudentDocumentTypeId",
                table: "StudentDocuments",
                column: "StudentDocumentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentDocuments_StudentId_StudentDocumentTypeId",
                table: "StudentDocuments",
                columns: new[] { "StudentId", "StudentDocumentTypeId" },
                unique: true,
                filter: "[StudentId] IS NOT NULL AND [StudentDocumentTypeId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_StudentDocumentTypes_DocumentTypeName",
                table: "StudentDocumentTypes",
